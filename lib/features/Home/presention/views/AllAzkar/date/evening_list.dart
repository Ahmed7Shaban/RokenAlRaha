final List<String> eveningAzkar = [
  ...
  "اللهم اجعل أول هذه الليلة صلاحًا، وأوسطها فلاحًا، وآخرها نجاحًا.",
  "اللهم إني أسألك خير هذه الليلة، فتحها، ونصرها، ونورها، وبركتها، وهداها.",
  "اللهم ارزقني فيها حسن الخاتمة، واجعل لي فيها من كل همٍ فرجًا.",
  "اللهم أعني على ذكرك وشكرك وحسن عبادتك.",
  "اللهم إني وكلتك أمري، فدبّرني فإني لا أُحسن التدبير.",
  "اللهم اجعل هذه الليلة شاهدًا لي لا عليّ.",
  "اللهم إني أمسيت في ذمتك، فأجرني من النار.",
  "اللهم لا تجعل مصيبتي في ديني، ولا تجعل الدنيا أكبر همي.",
  "اللهم افتح لي أبواب رزقك، وبارك لي في مسائي هذا."
];
